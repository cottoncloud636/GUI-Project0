...
public class CandleList {
    ...
    public void append(Candle cd) {
    	...
    	last.next=newNode; //initlally last points to null, after append, last points to the new node (aka. add a new node)
    	last=newNode; //make last point to the newNode
